  ...
  Widget build(BuildContext context) {
    const productList = [
      ProductDetail(
        ...
        productPrice: "₦ 34,800",
        imageUrl: "lib/assets/images/BeltTightening.png",
        iconImageUrl: "lib/assets/images/add-cart.png",
      ...
      ProductDetail(
        ...
        productPrice: "₦ 45,000",
        imageUrl: "lib/assets/images/BallJoint.png",
        iconImageUrl: "lib/assets/images/add-cart.png",
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        BottomNavigationBarItem(
            ...
            label: ""),
        BottomNavigationBarItem(
            icon: Image(image: AssetImage('lib/assets/images/cart.png')),
            label: ""),
        BottomNavigationBarItem(
            icon:  Image(
                image: AssetImage('lib/assets/images/bookmark-white.png')),
            label: ""),
        BottomNavigationBarItem(
            icon: Image(image: AssetImage('lib/assets/images/user.png')),
            label: ""),
      ]),
      body: const Column(
        children: [
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Products(
                    productName: "Volvo",
                    imageUrl: 'lib/assets/images/volvo.png',
                  ),
                  Products(
                    productName: "Volvo FMX",
                    imageUrl: 'lib/assets/images/volvofmx.png',
                  ),
                  Products(
